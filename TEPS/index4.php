...
<?php
	...
	if(isset($todo) and $todo=="search"){
		...
		$query="SELECT Passages.Set_Name, Passages.Passage_Type, Passages.Number, Passages.Passage FROM Passages JOIN summary ON Passages.Set_Name=summary.Set_Name WHERE $q $qq $qqq";
